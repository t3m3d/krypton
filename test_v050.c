...
int main(int argc, char** argv) {
    ...
    char* x = kr_str("10");
    char* result = (kr_truthy(kr_gt(x, kr_str("5"))) ? kr_str("big") : kr_str("small"));
    kr_print(kr_plus(kr_str("ternary1: "), result));
    char* y = kr_str("3");
    char* result2 = (kr_truthy(kr_gt(y, kr_str("5"))) ? kr_str("big") : kr_str("small"));
    kr_print(kr_plus(kr_str("ternary2: "), result2));
    char* z = kr_str("0");
    char* t3 = (kr_truthy(kr_gt(z, kr_str("0"))) ? kr_str("positive") : (kr_truthy(kr_eq(z, kr_str("0"))) ? kr_str("zero") : kr_str("negative")));
    kr_print(kr_plus(kr_str("ternary3: "), t3));
    char* pi = kr_str("314");
    char* greeting = kr_str("hello");
    kr_print(kr_plus(kr_str("const1: "), pi));
    kr_print(kr_plus(kr_str("const2: "), greeting));
    char* csv = kr_str("one::two::three");
    char* parts = kr_splitby(csv, kr_str("::"));
    kr_print(kr_plus(kr_str("splitBy: "), parts));
    char* lst = kr_str("apple,banana,cherry,date");
    kr_print(kr_plus(kr_str("listIndexOf1: "), kr_listindexof(lst, kr_str("cherry"))));
    kr_print(kr_plus(kr_str("listIndexOf2: "), kr_listindexof(lst, kr_str("grape"))));
    char* lst2 = kr_str("a,b,d,e");
    kr_print(kr_plus(kr_str("insertAt: "), kr_insertat(lst2, kr_str("2"), kr_str("c"))));
    char* lst3 = kr_str("x,y,z,w");
    kr_print(kr_plus(kr_str("removeAt: "), kr_removeat(lst3, kr_str("1"))));
    char* lst4 = kr_str("1,2,3,4");
    kr_print(kr_plus(kr_str("replaceAt: "), kr_replaceat(lst4, kr_str("2"), kr_str("99"))));
    kr_print(kr_plus(kr_str("fill: "), kr_fill(kr_str("4"), kr_str("hi"))));
    char* a = kr_str("1,2,3");
    char* b = kr_str("a,b,c");
    kr_print(kr_plus(kr_str("zip: "), kr_zip(a, b)));
    char* allSame = kr_str("5,5,5,5");
    char* mixed = kr_str("5,5,3,5");
    kr_print(kr_plus(kr_str("every1: "), kr_every(allSame, kr_str("5"))));
    kr_print(kr_plus(kr_str("every2: "), kr_every(mixed, kr_str("5"))));
    char* nones = kr_str("1,2,3");
    kr_print(kr_plus(kr_str("some1: "), kr_some(nones, kr_str("2"))));
    kr_print(kr_plus(kr_str("some2: "), kr_some(nones, kr_str("9"))));
    char* data = kr_str("a,b,a,c,a,b");
    kr_print(kr_plus(kr_str("countOf1: "), kr_countof(data, kr_str("a"))));
    kr_print(kr_plus(kr_str("countOf2: "), kr_countof(data, kr_str("b"))));
    char* nums = kr_str("10,20,30,40");
    kr_print(kr_plus(kr_str("sumList: "), kr_sumlist(nums)));
    char* nums2 = kr_str("5,1,9,3,7");
    kr_print(kr_plus(kr_str("maxList: "), kr_maxlist(nums2)));
    kr_print(kr_plus(kr_str("minList: "), kr_minlist(nums2)));
    kr_print(kr_plus(kr_str("hex1: "), kr_hex(kr_str("255"))));
    kr_print(kr_plus(kr_str("hex2: "), kr_hex(kr_str("16"))));
    kr_print(kr_plus(kr_str("bin1: "), kr_bin(kr_str("10"))));
    kr_print(kr_plus(kr_str("bin2: "), kr_bin(kr_str("255"))));
    kr_print(kr_str("ALL v0.5.0 TESTS PASSED"));
    return 0;
}
